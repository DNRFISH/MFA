...
catchSum <- catchSummary(FISH_query(con,QueryType = "Catch",SurveyId = 1162))
...
catchSum <- catchSummary(FISH_query(con,QueryType = "Catch",SurveyId = 805))
catchSum <- catchSummary(FISH_query(con,QueryType = "Catch",GearType = "LMFYKE",SurveyId = 805))
